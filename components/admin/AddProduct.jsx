    ...
    const handleCreate = async () => {
        ...
        try {
            const uploadRes = await axios.post(
                "https://api.cloudinary.com/v1_1/dhgd94h2z/image/upload",
                data
            );
                        ...
                        <div className="flex flex-col text-sm mt-4 w-full">
                            ...
                            <div className="mt-2 flex gap-2">
                                {extraOptions.map((item, index) => (
                                    <span
                                        className="inline-block border border-orange-500 text-orange-500  p-1 rounded-xl text-xs cursor-pointer hover:bg-orange-500 hover:text-white"
                                        key={index}
                                        onClick={() => {
                                            setExtraOptions(
